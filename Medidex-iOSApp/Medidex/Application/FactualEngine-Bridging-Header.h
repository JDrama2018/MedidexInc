//
//  FactualEngine-Bridging-Header.h
//  Medidex
//
//  Created by Dimitris Bouzikas on 23/05/17.
...
@interface FactualWrapper : NSObject <FactualCircumstanceDelegate, FactualDataRequestDelegate>
